    ...
    hooks: {
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var product, createdProduct, updatedProduct, product, productToUpdate, updatedProduct;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updatedProduct = __assign(__assign({}, product), { stripeId: createdProduct.id, priceId: createdProduct.default_price });
                            return [2 /*return*/, updatedProduct];
                        case 2:
                            if (!(args.operation === "update")) return [3 /*break*/, 4];
                            product = args.data;
                            return [4 /*yield*/, stripe_1.stripe.products.update(product.stripeId, {
                                    name: product.name,
                                    default_price: product.priceId,
                                })];
                        case 3:
                            productToUpdate = _a.sent();
                            updatedProduct = __assign(__assign({}, product), { stripeId: productToUpdate.id, priceId: productToUpdate.default_price });
                            return [2 /*return*/, updatedProduct];
