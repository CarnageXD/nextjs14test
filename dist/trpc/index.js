...
var auth_roter_1 = require("./routes/auth-roter");
var trpc_1 = require("./trpc");
var query_validatior_1 = require("../lib/validators/query-validatior");
var get_payload_1 = require("../get-payload");
var payment_router_1 = require("./routes/payment-router");
exports.appRouter = (0, trpc_1.router)({
    auth: auth_roter_1.authRouter,
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        query: query_validatior_1.QueryValidator,
    }))
        .query(function (_a) {
        var input = _a.input;
